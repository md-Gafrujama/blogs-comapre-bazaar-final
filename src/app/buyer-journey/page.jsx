...
const Blog2 = () => {
  ...
  const shareOnLinkedIn = () => {
    ...
    const summary = "Tech Buyer And Its Decision Making Journey";
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta property="og:image" content="https://blogs.compare-bazaar.com/images/Trigger.webp" />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`max-w-4xl mx-auto px-4 pt-10 pb-2 text-left animate-section transition-all duration-1000 ${isVisible[0] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="relative group">
            <img
              src="https://blogs.compare-bazaar.com/images/blog4.webp"
